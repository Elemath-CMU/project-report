...
\begin{itemize}
    \item Software Development Life Cycle (SDLC) ที่เลือกใช้ในโครงงานนี้คือแบบ Agile Model ซึ่งเป็นกระบวนการพัฒนาซอฟต์แวร์แบบทำไปปรับไป โดยจะมีการปรับปรุงและพัฒนาระบบอย่างต่อเนื่องตามความต้องการของผู้ใช้ โดยในแต่ละรอบของการพัฒนาจะมีการออกแบบ การพัฒนา การทดสอบ การส่งมอบระบบ และทบทวนสิ่งที่ทำไปในรอบนั้นๆเพื่อปรับปรุงในรอบถัดไป
